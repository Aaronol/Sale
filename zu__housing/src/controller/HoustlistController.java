...
public class HoustlistController {
    ...
    public String houselist(Model model, HttpSession httpSession, @RequestParam(required = false, defaultValue = "1") Integer page,
        ...
        for (Apply x : applies) {
            ...
            applylist.setStatus("已申请");
            applylist.setHouseid(x.getHouse_id());
            applylist.setAddress(x.getAddress());
            applylist.setArea(x.getArea());
            applylist.setPrice(x.getPrice());
            applylist.setId(Math.abs(100));
            houselist.add(applylist);
        }
